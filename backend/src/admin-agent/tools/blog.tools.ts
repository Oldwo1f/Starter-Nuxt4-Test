  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        status: { type: 'string', enum: ['draft', 'pending', 'active', 'archived'], description: 'Filtrer par statut' },
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        status: { type: 'string', enum: ['draft', 'pending', 'active', 'archived'], description: 'Statut (défaut: draft)' },
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        status: { type: 'string', enum: ['draft', 'pending', 'active', 'archived'] },
